<template>
    <div class="Polaris-FooterHelp">
        <div class="Polaris-FooterHelp__Content">
            ...
            <div class="Polaris-FooterHelp__Text">If you have any questions please contact us at <a href="mailto:info@crawlapps.com" target="_parent" style="color:#007ace;">info@crawlapps.com</a></div>
        </div>
    </div>
</template>
