            ...
            <div class="Polaris-Card">
                <div class="Polaris-Card__Header Polaris-Card__Header-meta">
                    <div class="Polaris-Stack Polaris-Stack--alignmentBaseline">
                        <div class="Polaris-Stack__Item Polaris-Stack__Item--fill">
                            <h2 class="Polaris-Heading">Pages</h2>
                        </div>
                        <import-export :resourceType="resourceType" :lbl1="`Page Configurations`" :shop="shop" :checkedIDs="checkedIDs" :is_data="pageList.length > 0"></import-export>
                    </div>
                </div>
                ...
                <div class="Polaris-Card__Section">
                    <div class="d-flex justify-content-between{">
                        ...
                        <button type="button" class="Polaris-Button Polaris-Button--primary ml-16" v-on:click="getPages(1)"><span
                        ...
                        <table class="w-100">
                            ...
                            <tr v-if="pageList.length > 0">
                                <th class="text-left" style="width: 18px;" id="multi-del" colspan="0">
                                    <multi-delete ref="multidelete" :resourceType="resourceType" :list="pageList" :next_page="next_page" :checkedIDs="checkedIDs" @update="updateChecked"></multi-delete>
                                </th>
                                <th class="text-left" v-if="checkedIDs.length <= 0">
                                    <h3><span class="Polaris-TextStyle--variationStrong">Pages</span></h3>
                                </th>
                                <th class="text-left" v-if="checkedIDs.length <= 0">
                            ...
                            <tr v-else-if="pageList.length > 0"
                                v-for="(page, index) in pageList" :key="index" class="Polaris-ResourceItem">
                                <td style="width: 18px;">
                                    <label class="Polaris-Choice" :for="`chkbox`+ index">
                                        <span class="Polaris-Choice__Control">
                                            <span class="Polaris-Checkbox">
                                                <input type="checkbox" class="Polaris-Checkbox__Input" aria-invalid="false" role="checkbox" aria-checked="false" value="" :id="`chkbox`+ index" :checked="page.is_checked" @click="checkSingle(page.id,index)">
              ...
              <path d="M8.315 13.859l-3.182-3.417a.506.506 0 0 1 0-.684l.643-.683a.437.437 0 0 1 .642 0l2.22 2.393 4.942-5.327a.437.437 0 0 1 .643 0l.643.684a.504.504 0 0 1 0 .683l-5.91 6.35a.437.437 0 0 1-.642 0"></path>
                                ...
                                <router-link
                                    :to="{name :'metafieldvalue', params: { resourceType : resourceType, resource: page, shop: shop  }}"
                                ...
                                <router-link
                                    ...
                                    tag="td" class="">
                                    <div class="d-flex align-center">
                                        <p class="mb-0">{{page.created_at}}</p>
                                    </div>
                                </router-link>
                                <router-link
                                    :to="{name :'metafieldvalue', params: { resourceType : resourceType, resource: page, shop: shop  }}"
                                    tag="td" class="">
                                    <div v-if="page.published_at === 'Hidden'" style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb;"><span class="Polaris-Badge Polaris-Badge--progressComplete"><span class="Polaris-Badge__Content">{{page.published_at}}</span></span></div>

                                    <div v-if="page.published_at === 'Visible'" style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb;"><span class="Polaris-Badge Polaris-Badge--statusSuccess"><span class="Polaris-Badge__Content">{{page.published_at}}</span></span></div>
                                </router-link>
                            </tr>
                            <tr v-else>
                                <td colspan="4" class="text-center">
                                    ...
                                    <h2 class="Polaris-Heading">Could not find any Page</h2>
                    ...
                    <custom-paginate v-if="pageList.length > 0" :prev_page="prev_page" :next_page="next_page" :resourceType="resourceType"></custom-paginate>
                </div>
            </div>
        </div>
    ...
    export default {
        ...
        methods: {
            async getPages(page) {
                ...
                let endPoint = ( page === 1 ) ? '/get-pages?s=' + base.search : '/get-pages?page=' + page + '&s=' + base.search;

                await axios.get(endPoint)
                    .then(res => {
                        var data = res.data.data;
                        base.pageList = data.page;
            ...
            checkSingle(id, index){
                ...
                base.isMultiCheck = false;
                base.pageList[index].is_checked = !base.pageList[index].is_checked;
            ...
            updateChecked(type){
                ...
                if( base.isMultiCheck ){
                    base.pageList.forEach(function(element){
        ...
        created() {
            ...
            base.$root.$on('get-data', function(rtype, page){
